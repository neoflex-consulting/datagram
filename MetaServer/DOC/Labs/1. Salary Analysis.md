...
5. Нажать ![](img/Common/add%20file.PNG) -> Property (2 раза)
...
8. Прокрутить вверх страницы
9. ![](img/Common/save.PNG) Сохранить
10. Вернуться в трансформацию: ![](img/Common/home.PNG) / ETL / Transformation / tr_salary_step1
11. В нижней панели инструментов должны появиться два этих параметра (если панель скрыта, то нажать ![](img/Common/run.PNG))
...
9. Если возникла ошибка: relation "employeepayhistory" does not exist
   - Изменить **from employeepayhistory** на **from humanresources.employeepayhistory**
...
7. Нажать галочку ![](img/Common/check.PNG) (Apply)
...
2. ![](img/Common/table.PNG) Под объектом нажать знак Таблицы (View content)
