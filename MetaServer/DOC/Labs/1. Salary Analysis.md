...
10. Заполнить поля:
   ...
   - Value: 2013-12-01
   - Description: Переменная для бизнес-правила: Повышение ЗП максимум 1 раз в год
11. ![](img/Common/save.PNG) Нажать Save в этой же строке
12. ![](img/Common/save.PNG) Нажать Save в нижней панели
...
>/* Если в таблице вернулись пустые строки, но есть столбцы - не обращать внимание. Данные там есть.
