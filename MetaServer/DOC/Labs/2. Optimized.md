...
***
>##### №1. Выбор Шага трансформации для Pushdown-оптимизация
1. Перейти в раздел ![](img/Common/home.PNG) / ETL / Project / labWorks / tr_pushdown
2. Справа сверху навести на плюсик и выбрать Source Code Editor
3. Выбрать:
   - Tab "Step"
...
5. Определить причину:
   ...
   - Проанализировать Expression:
      ...
      - Spark Pushdown-оптимизация не умеет переносить функции в Select самостоятельно
      - Поэтому, в данном случае, Pushdown-оптимизация не отработала
