...
>##### №6
1. Под объектом "Selection yearGreat2006" нажать ![](img/Common/txt.PNG) (Edit Selection)
...
7. Закрыть Tab Selection Editor yearGreat2006

>##### №7
1. Перетащить на поле объект из ![](img/Transformation/Transform.PNG)
    - Selection
2. Соединить его слева с Selection yearGreat2006
3. Справа в Свойствах:
    - Name: yearLess2012
    - Label: yearLess2012
...
1. Перетащить на поле объект из ![](img/Transformation/Transform.PNG)
   - Aggregation
2. Соединить его с Selection yearGreat2006
