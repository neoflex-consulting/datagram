...
public class GenerationBase {
    ...
    public static File getSourcesDirectory(String entityType){
        return new File(Context.current.getContextSvc().getGitflowSvc().getCurrentSourcesDir(), entityType);
    }

    public static String getSourcesDirectoryPath(String entityType){
        return  getSourcesDirectory(entityType).getAbsolutePath()
    }
