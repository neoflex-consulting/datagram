...
def entity = session.createQuery("from rt.TransformationDeployment where name = :name").setParameter("name", "autogenerated_tr_tr_aw_salary_analysis_step1").uniqueResult() 
...
entity.transformation = session.createQuery("from etl.Transformation where name = :name").setParameter("name", "tr_aw_salary_analysis_step1").uniqueResult()
