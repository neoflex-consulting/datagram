...
def entity = session.createQuery("from rt.TransformationDeployment where name = :name").setParameter("name", "autogenerated_tr_tr_adventureWorks").uniqueResult() 
...
entity.transformation = session.createQuery("from etl.Transformation where name = :name").setParameter("name", "tr_adventureWorks").uniqueResult()
